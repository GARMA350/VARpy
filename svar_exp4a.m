...
Ttab = readtable('data_nueva_trimestral_4a.xlsx', 'Sheet', 'Hoja1');
...
n_ventanas = 2;
ventana_ini = [datetime(2014,1,1), datetime(2016,1,1)];
ventana_fin = [datetime(2024,12,31), datetime(2026,12,31)];
ventana_lbl = {'2014-2024', '2016-2026'};
